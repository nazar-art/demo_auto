...
import static net.lelyak.core.utils.ElementUtils.existsInClasspath;
import static net.lelyak.core.utils.ElementUtils.getResourceFromClasspath;
import static net.lelyak.core.utils.ElementUtils.isOnRemoteWebDriver;


/**
 * Represents web page file upload element.
 */
public class FileInput extends AbstractPageElement {

    public FileInput(WebElement wrappedElement, String name, String page) {
