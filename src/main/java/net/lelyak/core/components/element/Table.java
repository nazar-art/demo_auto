...
import net.lelyak.core.exceptions.HtmlElementsException;
...
import static net.lelyak.core.components.element.Table.ListConverter.toListsConvertingEachItem;
import static net.lelyak.core.components.element.Table.MapConverter.toMapsConvertingEachValue;
import static net.lelyak.core.components.element.Table.WebElementToTextConverter.toText;
import static net.lelyak.core.components.element.Table.WebElementToTextConverter.toTextValues;
